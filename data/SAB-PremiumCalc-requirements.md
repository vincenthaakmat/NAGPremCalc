# SAB - Saba premium calculation setup

Territory code: `SAB`
Currency: `USD` / `US$`
Engine: `GetPremRateSEM`

## Saba-specific base premium rules

- Third Party (`T`) uses `ThirdPRateSABA`, matched by `CountryCode`, `VehUse`, `Age`, and `VehType`.
...
- `ThirdPRateSABA`: `CountryCode`, `VehUse`, `Age`, `VehType`, `Amount`, `LoadPerc`
